...
data:
  ...
  bundledCode: "#line 1 \"test/aoj-grl-4-a.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/5/GRL/all/GRL_4_A\"\
    ...
    const int inf = 1e9;\nconst ll INF = 1e18;\n#pragma endregion\n\nvoid main_();\n\
    \nint main() {\n\tmain_();\n\treturn 0;\n}\n#line 5 \"test/aoj-grl-4-a.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/aoj-grl-4-a.test.cpp
layout: document
redirect_from:
- /verify/test/aoj-grl-4-a.test.cpp
- /verify/test/aoj-grl-4-a.test.cpp.html
