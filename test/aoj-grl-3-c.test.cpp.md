...
data:
  ...
  bundledCode: "#line 1 \"test/aoj-grl-3-c.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/5/GRL/all/GRL_3_C\"\
    ...
    \ i and edges[group_number[e.to]] != i) {\n\t\t\t\t\t\t\tedges[group_number[e.to]]\
    ...
    const int inf = 1e9;\nconst ll INF = 1e18;\n#pragma endregion\n\nvoid main_();\n\
    \nint main() {\n\tmain_();\n\treturn 0;\n}\n#line 6 \"test/aoj-grl-3-c.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/aoj-grl-3-c.test.cpp
layout: document
redirect_from:
- /verify/test/aoj-grl-3-c.test.cpp
- /verify/test/aoj-grl-3-c.test.cpp.html
