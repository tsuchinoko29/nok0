...
data:
  ...
  bundledCode: "#line 1 \"test/aoj-grl-3-a.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/5/GRL/all/GRL_3_A\"\
    ...
    const int inf = 1e9;\nconst ll INF = 1e18;\n#pragma endregion\n\nvoid main_();\n\
    \nint main() {\n\tmain_();\n\treturn 0;\n}\n#line 6 \"test/aoj-grl-3-a.test.cpp\"\
    \n\nvoid main_() {\n\tINT(v, e);\n\tgraph g(v, e, 0, 0, 0);\n\tlow_link lnk(g);\n\
  ...
  verifiedWith: []
documentation_of: test/aoj-grl-3-a.test.cpp
layout: document
redirect_from:
- /verify/test/aoj-grl-3-a.test.cpp
- /verify/test/aoj-grl-3-a.test.cpp.html
