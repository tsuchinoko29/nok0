...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"graph/dag_mcf.hpp\"\n#include <atcoder/mincostflow>\n#include\
    \ <iostream>\n\n#line 2 \"graph/graph.hpp\"\n#include <algorithm>\n#include <cassert>\n\
    #include <deque>\n#line 6 \"graph/graph.hpp\"\n#include <queue>\n#include <tuple>\n\
    #include <utility>\n#include <vector>\n\nstruct Edge {\n\tint to;\n\tlong long\
    \ cost;\n\tEdge() = default;\n\tEdge(int to_, long long cost_) : to(to_), cost(cost_)\
    \ {}\n\tbool operator<(const Edge &a) const { return cost < a.cost; }\n\tbool\
    \ operator>(const Edge &a) const { return cost > a.cost; }\n\tfriend std::ostream\
    \ &operator<<(std::ostream &s, Edge &a) {\n\t\ts << \"to: \" << a.to << \", cost:\
...
layout: document
redirect_from:
- /library/graph/dag_mcf.hpp
- /library/graph/dag_mcf.hpp.html
